...
export default function BoxBody()   {
    ...
    const randomClickComment = ["please don't click on me.", "do not click on me.", "ouch!", "I would rather not have you click on me.", "it hurts when you click me.", "please..", "stop clicking me.", "you can not just click on me like that.", "just like cigarettes, every click slightly reduces my life expectancy."];
    ...
    /////////////////////////// INITIALIZE workImPath STATE
     ...
     const [allStaticsLoaded, setallStaticsLoaded] = useState(false);
